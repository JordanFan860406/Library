          ...
          <nav class="navbar navbar-expand-lg beta-menu navbar-dropdown align-items-center fixed-top navbar-toggleable-sm navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="">會員資料查詢</a>
                </li>
								<li class="nav-item">
      ...
      <div id="content">
	         ...
	         <div class="row">
		           <div class="col-md-12 align-center" style="text-align:center">
								 <hr class="my-3">
								 <img src="picture/Nknu_logo.png" height="150" width="150" class="d-inline-block align-top" alt="">
                 <h1 class="display-4" >高師大座位預約系統</h1>
                 <h1 id="username" class="display-5"></h1>
                  <hr class="my-3">
    							<!-- 功能區 -->
                  <div class="row">
                		<div class="col-md-12">
                      <div class="row">
                        <!-- 會員資料 -->
                         <div class="col-md-4">
													 <a href="user.php" class="icon-block">
    										 		<i class="material-icons" style="font-size:200px;color:black">account_box</i>
    								 				<h3 style="color:black;font-weight:bold;">會員資料</h3>
									 				</a>
                         </div>
                         <!-- 座位預約 -->
                         <div class="col-md-4">
													 <a href="reservation.php" class="icon-block">
    										 		<i class="material-icons" style="font-size:200px;color:black">event_note</i>
    								 				<h3 style="color:black;font-weight:bold;">座位預約</h3>
									 				</a>
                         </div>
                         <!-- 預約紀錄 -->
                         <div class="col-md-4">
													 <a href="history.php" class="icon-block">
													  <i class="material-icons" style="font-size:200px;color:black">storage</i>
													 <h3 style="color:black;font-weight:bold;">預約紀錄</h3>
												 </a>
                         </div>
                       </div>
                     </div>
			 ...
			 $(document).ready(function() {
					 ...
					 $.ajax({
						 ...
						 data:search
								 ...
								 if(data.msg == "success")
								 {
									document.getElementById("username").innerHTML = "歡迎"+"<em>"+data.name+"</em>"+" 進行使用";
								 }
